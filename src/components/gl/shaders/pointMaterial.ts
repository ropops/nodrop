  ...
  constructor() {
    super({
      ...
      void main() {
        ...
        gl_PointSize = max(vDistance * uBlur * uPointSize, 3.0) * visibility;
      }`,
      fragmentShader: /* glsl */ `
      ...
      void main() {
        ...
        float alpha = (1.04 - clamp(vDistance, 0.0, 1.0)) * clamp(smoothstep(-0.5, 0.25, vPosY), 0.0, 1.0) * uOpacity * revealMask * uRevealProgress * sparkleBrightness * vVisibility;
